...
namespace IO.Swagger.Api
{
    ...
    public interface IMeasurementApi
    {
        ...
        /// <returns>InlineResponse2005</returns>
        InlineResponse2005 MeasurementsPost (string accessToken, MeasurementPost body);
        ...
        InlineResponse20020 MeasurementsIdGet (int? id, string accessToken);
    ...
    public class MeasurementApi : IMeasurementApi
    {
        ...
        /// <param name="sort">Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.</param> 
        /// <returns>InlineResponse2005</returns>            
        public InlineResponse2005 MeasurementsGet (string accessToken, int? userId, string clientId, int? connectorId, int? variableId, int? sourceId, string startTime, double? value, int? unitId, double? originalValue, int? originalUnitId, int? duration, string note, double? latitude, double? longitude, string location, string createdAt, string updatedAt, string error, int? limit, int? offset, string sort)
        {
        ...
        /// <param name="body">Measurement that should be stored</param> 
        /// <returns>InlineResponse2005</returns>            
        public InlineResponse2005 MeasurementsPost (string accessToken, MeasurementPost body)
        {
        ...
        /// <param name="accessToken">User&#39;s OAuth2 access token</param> 
        /// <returns>InlineResponse20020</returns>            
        public InlineResponse20020 MeasurementsIdGet (int? id, string accessToken)
        {
