...
namespace IO.Swagger.Api
{
    ...
    public interface IApplicationEndpointsApi
    {
        ...
        InlineResponse2003 ApplicationConnectionsGet (string accessToken, int? connectorId, string connectStatus, string connectError, string updateRequestedAt, string updateStatus, string updateError, string lastSuccessfulUpdatedAt, string createdAt, string updatedAt, int? limit, int? offset, string sort);
        ...
        InlineResponse2004 ApplicationCredentialsGet (string accessToken, int? connectorId, string attrKey, string attrValue, string createdAt, string updatedAt, int? limit, int? offset, string sort);
        ...
        InlineResponse2006 ApplicationTrackingRemindersGet (string accessToken, string clientId, string createdAt, string updatedAt, int? limit, int? offset, string sort);
        ...
        InlineResponse2007 ApplicationUpdatesGet (string accessToken, int? connectorId, int? numberOfMeasurements, bool? success, string message, string createdAt, string updatedAt, int? limit, int? offset, string sort);
        ...
        InlineResponse20010 ApplicationVariableUserSourcesGet (string accessToken, int? variableId, int? timestamp, int? earliestMeasurementTime, int? latestMeasurementTime, string createdAt, string updatedAt, int? limit, int? offset, string sort);
        ...
        InlineResponse20011 ApplicationVotesGet (string accessToken, string clientId, int? causeId, int? effectId, int? value, string createdAt, string updatedAt, int? limit, int? offset, string sort);
    ...
    public class ApplicationEndpointsApi : IApplicationEndpointsApi
    {
        ...
        /// <param name="sort">Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.</param> 
        /// <returns>InlineResponse2003</returns>            
        public InlineResponse2003 ApplicationConnectionsGet (string accessToken, int? connectorId, string connectStatus, string connectError, string updateRequestedAt, string updateStatus, string updateError, string lastSuccessfulUpdatedAt, string createdAt, string updatedAt, int? limit, int? offset, string sort)
        {
            
    
            var path = "/application/connections";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationConnectionsGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationConnectionsGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="sort">Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.</param> 
        /// <returns>InlineResponse2004</returns>            
        public InlineResponse2004 ApplicationCredentialsGet (string accessToken, int? connectorId, string attrKey, string attrValue, string createdAt, string updatedAt, int? limit, int? offset, string sort)
        {
            
    
            var path = "/application/credentials";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationCredentialsGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationCredentialsGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        public InlineResponse2005 ApplicationMeasurementsGet (string accessToken, string clientId, int? connectorId, int? variableId, int? sourceId, string startTime, double? value, int? unitId, double? originalValue, int? originalUnitId, int? duration, string note, double? latitude, double? longitude, string location, string createdAt, string updatedAt, string error, int? limit, int? offset, string sort)
        {
            ...
            var path = "/application/measurements";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationMeasurementsGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationMeasurementsGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="sort">Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.</param> 
        /// <returns>InlineResponse2006</returns>            
        public InlineResponse2006 ApplicationTrackingRemindersGet (string accessToken, string clientId, string createdAt, string updatedAt, int? limit, int? offset, string sort)
        {
            
    
            var path = "/application/trackingReminders";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationTrackingRemindersGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationTrackingRemindersGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="sort">Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.</param> 
        /// <returns>InlineResponse2007</returns>            
        public InlineResponse2007 ApplicationUpdatesGet (string accessToken, int? connectorId, int? numberOfMeasurements, bool? success, string message, string createdAt, string updatedAt, int? limit, int? offset, string sort)
        {
            
    
            var path = "/application/updates";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationUpdatesGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationUpdatesGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        public InlineResponse2008 ApplicationUserVariableRelationshipsGet (string accessToken, int? id, string confidenceLevel, double? confidenceScore, string direction, int? durationOfAction, string errorMessage, int? onsetDelay, int? outcomeVariableId, int? predictorVariableId, int? predictorUnitId, double? sinnRank, string strengthLevel, double? strengthScore, string vote, double? valuePredictingHighOutcome, double? valuePredictingLowOutcome, int? limit, int? offset, string sort)
        {
            ...
            var path = "/application/userVariableRelationships";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationUserVariableRelationshipsGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationUserVariableRelationshipsGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        public InlineResponse2009 ApplicationUserVariablesGet (string accessToken, string clientId, int? parentId, int? variableId, int? defaultUnitId, double? minimumAllowedValue, double? maximumAllowedValue, double? fillingValue, int? joinWith, int? onsetDelay, int? durationOfAction, int? variableCategoryId, int? updated, int? _public, bool? causeOnly, string fillingType, int? numberOfMeasurements, int? numberOfProcessedMeasurements, int? measurementsAtLastAnalysis, int? lastUnitId, int? lastOriginalUnitId, int? lastOriginalValue, double? lastValue, double? lastOriginalValue2, int? lastSourceId, int? numberOfCorrelations, string status, string errorMessage, string lastSuccessfulUpdateTime, double? standardDeviation, double? variance, double? minimumRecordedValue, double? maximumRecordedValue, double? mean, double? median, int? mostCommonUnitId, double? mostCommonValue, double? numberOfUniqueDailyValues, int? numberOfChanges, double? skewness, double? kurtosis, double? latitude, double? longitude, string location, string createdAt, string updatedAt, bool? outcome, string sources, int? earliestSourceTime, int? latestSourceTime, int? earliestMeasurementTime, int? latestMeasurementTime, int? earliestFillingTime, int? latestFillingTime, int? limit, int? offset, string sort)
        {
            ...
            var path = "/application/userVariables";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationUserVariablesGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationUserVariablesGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="sort">Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.</param> 
        /// <returns>InlineResponse20010</returns>            
        public InlineResponse20010 ApplicationVariableUserSourcesGet (string accessToken, int? variableId, int? timestamp, int? earliestMeasurementTime, int? latestMeasurementTime, string createdAt, string updatedAt, int? limit, int? offset, string sort)
        {
            
    
            var path = "/application/variableUserSources";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationVariableUserSourcesGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationVariableUserSourcesGet: " + response.ErrorMessage, response.ErrorMessage);
        ...
        /// <param name="sort">Sort by given field. If the field is prefixed with &#39;-&#39;, it will sort in descending order.</param> 
        /// <returns>InlineResponse20011</returns>            
        public InlineResponse20011 ApplicationVotesGet (string accessToken, string clientId, int? causeId, int? effectId, int? value, string createdAt, string updatedAt, int? limit, int? offset, string sort)
        {
            
    
            var path = "/application/votes";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationVotesGet: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling ApplicationVotesGet: " + response.ErrorMessage, response.ErrorMessage);
