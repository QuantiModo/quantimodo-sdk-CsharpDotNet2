...
namespace IO.Swagger.Api
{
    ...
    public interface ICommonVariableRelationshipApi
    {
        ...
        InlineResponse20013 CommonVariableRelationshipsPost (string accessToken, CommonVariableRelationship body);
        ...
        /// <param name="accessToken">User&#39;s OAuth2 access token</param>
        /// <returns>InlineResponse20013</returns>
        InlineResponse20013 CommonVariableRelationshipsIdGet (int? id, string accessToken);
    ...
    public class CommonVariableRelationshipApi : ICommonVariableRelationshipApi
    {
        ...
        /// <param name="body">CommonVariableRelationship that should be stored</param> 
        /// <returns>InlineResponse20013</returns>            
        public InlineResponse20013 CommonVariableRelationshipsPost (string accessToken, CommonVariableRelationship body)
        {
        ...
        /// <param name="accessToken">User&#39;s OAuth2 access token</param> 
        /// <returns>InlineResponse20013</returns>            
        public InlineResponse20013 CommonVariableRelationshipsIdGet (int? id, string accessToken)
        {
